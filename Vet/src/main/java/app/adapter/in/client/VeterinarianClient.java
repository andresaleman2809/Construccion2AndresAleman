...
import app.adapter.in.builder.TheClinicalOrderBuilder;
...
public class VeterinarianClient {
	...
	@Autowired
	private TheClinicalOrderBuilder TheclinicalOrderBuilder;
	@Autowired
	...
	private ClinicalOrder readOrderData() throws Exception {
		...
		String doce = reader.nextLine();
		return TheclinicalOrderBuilder.builder(veterinarian, id, medicine, doce);
